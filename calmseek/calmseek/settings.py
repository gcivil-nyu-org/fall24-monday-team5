"""
Django settings for calmseek project.
...
ALLOWED_HOSTS = ['django-env3.eba-4p3up9it.us-east-1.elasticbeanstalk.com','127.0.0.1']
...
ROOT_URLCONF = 'calmseek.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'calmseek/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
